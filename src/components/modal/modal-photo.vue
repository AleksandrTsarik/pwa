<template>
  ...
  <div v-if="showCropper" class="modal-cropper">
    <div class="modal-cropper__header">
      ...
      <div class="modal-cropper__title">{{ title || "Миниатюра" }}</div>
    </div>
    ...
    <div class="modal-cropper__footer">
      <button class="btn btn-light" @click="applyCrop">
...
export default {
  ...
  methods: {
    ...
    loadImage() {
      ...
      img.onload = () => {
        this.image = img;
        // Установить центр круга в центр канваса
        this.cropX = this.canvasSize / 2;
        this.cropY = this.canvasSize / 2;
        this.drawCanvas();
      };
